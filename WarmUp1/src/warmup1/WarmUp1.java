 ...
 */
public class Warmup1 extends Application {
...
// Use style classes to set properties previously set above (with some changes)       
        ...
        ImageView imageHouse = new ImageView(
                    new Image(Warmup1.class.getResourceAsStream("graphics/house.png")));
        ...
        ImageView imageChart = new ImageView(
                    new Image(Warmup1.class.getResourceAsStream("graphics/piechart.png")));
...
// Use style classes to set properties previously set above        
        ...
        for (int i=0; i<8; i++) {
            pages[i] = new ImageView(
                    new Image(Warmup1.class.getResourceAsStream(
